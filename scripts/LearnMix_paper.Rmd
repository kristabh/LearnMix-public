...
# Scripts runs with on R-3.6.3. 
# How to install old versions  https://support.rstudio.com/hc/en-us/articles/219949047-Installing-older-versions-of-packages
# I like RSwitch for Mac to manage my R versions https://rud.is/rswitch/

library(groundhog) #Make  R scripts reproducible
groundhog.day = "2019-06-01" 

#packages <- c("knitr", "eyetrackingR", "tidyverse", "lme4", "corrr", "ez", "apa", "english", "lmerTest", "devtools")

packages <- c("knitr", "eyetrackingR", "dplyr", "readr", "ggplot2", "forcats", "stringr", "lme4", "corrr", "ez", "apa", "english", "lmerTest", "devtools")
